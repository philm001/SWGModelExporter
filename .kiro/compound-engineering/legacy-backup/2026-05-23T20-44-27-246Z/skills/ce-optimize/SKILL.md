...
1. **Run the ce-code-review skill** on the cumulative diff (baseline to final). Load the `ce-code-review` skill with `mode:autofix` on the optimization branch.
2. **Run the ce-compound skill** to document the winning strategy as an institutional learning.
