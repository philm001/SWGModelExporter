...
the ce-compound skill mode:headless              # Non-interactive run for automations
the ce-compound skill mode:headless [context]    # Non-interactive run with context hint
```
...
re-run the ce-compound skill in a fresh session.
```
...
Refresh recommendation: <none | scope hint for the ce-compound-refresh skill>
