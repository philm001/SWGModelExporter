...
- Use the @ce-repo-research-analyst subagent to: Scope: technology, architecture, patterns. {planning context summary}
- Use the @ce-learnings-researcher subagent to: planning context summary
Collect:
...
- Use the @ce-best-practices-researcher subagent to: planning context summary
- Use the @ce-framework-docs-researcher subagent to: planning context summary
...
- Use the @ce-spec-flow-analyzer subagent to: planning context summary, research findings
